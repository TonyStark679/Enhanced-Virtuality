...
🤖 To manually test Qwen offline mode, turn off your internet/Wi-Fi and type your message into the prompt.
🔄 auto mode handles the Gemini ↔ Qwen switching automatically.
🧠 Qwen requires a compatible GGUF model and llama-cli.
📦 Requirements
...
🔑 A Gemini API key
⚠️ The Qwen model is not included in this repository because GGUF model files can be very large.
🚀 Setup
...
📜 License
MIT License.
⚡ Built for Termux. Powered by Gemini. Backed up by Qwen.
JARVIS either way.
